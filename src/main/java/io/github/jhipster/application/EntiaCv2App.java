...
public class EntiaCv2App {

    private static final Logger log = LoggerFactory.getLogger(EntiaCv2App.class);

    private final Environment env;

    public EntiaCv2App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ENTIACv2.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EntiaCv2App.class);
